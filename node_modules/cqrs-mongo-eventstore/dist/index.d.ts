...
import Event from "cqrs/dist/Event";
import Snap from "cqrs/dist/Snap";
import { EventEmitter } from "events";
import EventStore from "cqrs/dist/EventStore";
export default class MongoEventStore extends EventEmitter implements EventStore {
    private sagas;
    private events;
    private snaps;
    constructor(url: any, collectionNames?: {
        sagas: string;
        events: string;
        snaps: string;
    });
    ...
    getSnapshotByLastIndex(actorId: any, index: any): Promise<void>;
