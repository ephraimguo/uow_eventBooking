...
function createMiddel(opt) {
    ...
    listeners.filter(listener => /.*\.js$/.test(listener)).forEach(listener => require(path.join(listenerPath, listener))(Object.assign({}, opt, { domain,  eventstore})));
    const router = express_1.Router();
    router.post(baseUrl + "/:actor/create", function (req, res, next) {
    ...
    router.post(baseUrl + "/:actor/:id/:method", async function (req, res, next) {
        req.type = req.params.actor;
        req.data = req.body;
